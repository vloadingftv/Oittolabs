    ...
    <>
      ...
      <section className="border-t border-sand-200 bg-sand-100 py-16 md:py-20">
        <div className="shell">
            ...
            {byYear.map(([year, items]) => (
              <div key={year}>
                <div className="flex items-baseline gap-6">
                  <h3 className="font-display text-4xl text-ink-900/25">
                    {year}
                  </h3>
                  ...
                  {items.map((item) => (
                    <li key={item.id}>
                      ...
                      >
                        <time
                          dateTime={item.date}
                          className="w-28 shrink-0 text-[0.6875rem] font-semibold uppercase tracking-[0.1em] tabular-nums text-sand-400"
                        >
                        ...
                        <span className="flex shrink-0 items-center gap-3">
                          ...
                          <ExternalIcon className="size-3.5 text-brass-500 opacity-0 transition-opacity group-hover:opacity-100" />
                        </span>
                      </a>
                    </li>
                  ))}
          ...
          <p className="mt-16 max-w-2xl text-sm leading-relaxed text-sand-500">
